...
class SearchPhotoDetailsActivity : AppCompatActivity() {
    lateinit var searchData : PhotosItem
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_search_photo_details_activity)

        searchData = intent.getSerializableExtra("searchData") as PhotosItem
        ...
        Glide
            .with(this)
            .load(searchData.imageLinks?.small)
        ...
        when (item.itemId) {
            ...
            R.id.nav_settings -> {
                ...
                try {
                    Glide.with(this)
                        .asBitmap()
                        .load(searchData?.imageLinks?.regular)
